...
export default function EditMenuItemPage({
    ...
    const { data: menuItemData, isLoading: isLoadingMenuItem } = useGetMenuItemQuery(params.menuId);
    ...
    useEffect(() => {
        if (menuItemData?.data) {
            const { name, description, price, category, is_available, image } = menuItemData.data;
            form.reset({
                name,
                description,
    ...
    async function onSubmit(data: MenuFormValues) {
        try {
            ...
            router.push(`/owner/restaurants/${params.restaurantId}/menu`);
            router.refresh();
        } catch (error) {
